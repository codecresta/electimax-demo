...
Electimax is a piece of software designed to solve multiple-choice knapsack problems. Simply put Electimax allows you to select a combination of items (or "projects") from a series of multiple-choices, in order to get the overall best "bang for buck".
